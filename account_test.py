...
class TestAccount(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_account.account_name, "junior")
        self.assertEqual(self.new_account.user_name, "kamau")
        self.assertEqual(self.new_account.password, "123456")
        self.assertEqual(self.new_account.email, "ephraimkamau54@gmail.com")
